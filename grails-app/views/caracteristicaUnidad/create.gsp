...
<html>
	...
	<body>
		<a href="#create-caracteristicaUnidad" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-caracteristicaUnidad" class="content scaffold-create" role="main">
