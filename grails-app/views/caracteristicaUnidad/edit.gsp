...
<html>
	...
	<body>
		<a href="#edit-caracteristicaUnidad" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-caracteristicaUnidad" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${caracteristicaUnidadInstance?.version}" />
				<fieldset class="form">
