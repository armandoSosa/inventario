	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="create" action="insertar">Nuevo Tipo de Usuario</g:link></li>
			</ul>
		</div>
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="tipo" title="${message(code: 'tipoUsuario.tipo.label', default: 'Tipo')}" />
				...
				<g:each in="${tipoUsuarioInstanceList}" status="i" var="tipoUsuarioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${tipoUsuarioInstance.id}">${fieldValue(bean: tipoUsuarioInstance, field: "tipo")}</g:link></td>
