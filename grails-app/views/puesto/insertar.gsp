	...
	<body>
		...
		<div id="inline">		
			<div id="create-departamento" class="content scaffold-create" role="main">
				...
				<g:form action="save_departamento_puesto" controller="departamento">
				<fieldset class="form">
					<g:render template="../departamento/forma"/>
				</fieldset>
				<fieldset class="buttons">
					<g:submitButton name="create" class="save" value="${message(code: 'default.button.create.label', default: 'Create')}" />
				</fieldset>
		...
		<div id="inline2">		
			<div id="create-nivel" class="content scaffold-create" role="main">
				<h1>Nuevo Nivel</h1>
				<g:form action="save_nivel" controller="nivel">
				<fieldset class="form">
					<g:render template="../nivel/forma"/>
				</fieldset>
				<fieldset class="buttons">
					<g:submitButton name="create" class="save" value="${message(code: 'default.button.create.label', default: 'Create')}" />
				</fieldset>
