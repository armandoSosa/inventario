...
<html>
	...
	<body>
		<a href="#edit-puestoPersona" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-puestoPersona" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${puestoPersonaInstance?.version}" />
				<fieldset class="form">
