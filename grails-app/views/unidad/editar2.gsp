...
<body>
	...
	<div id="create-unidad" class="content scaffold-create" role="main">
		...
		<g:form id="formunidad" name="formunidad" action="edit_unidad">
			<fieldset class="form">
				<div
				...
				<g:hiddenField name="idUnidad" value="${unidadInstance?.id}"/>
			</fieldset>
			<fieldset class="buttons">
				<a class="save" onClick="validarEnvio()">Crear</a>
				<g:link name="cancel" class="cancelar" id ="${unidadInstance?.id}" action="mostrar">Cancelar</g:link>
			</fieldset>
		</g:form>
	</div>
</body>
