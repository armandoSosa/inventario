			...
			<ol class="property-list usuario">
				...
				<li class="fieldcontain">
					<span id="tipoUsuario-label" class="property-label"><g:message code="usuario.tipoUsuario.label" default="Tipo Usuario" /></span>
						...
						<span class="property-value" aria-labelledby="tipoUsuario-label">${usuarioInstance?.tipoUsuario?.encodeAsHTML()}</span>
				...
				<li class="fieldcontain">
					<span id="fechaInicio-label" class="property-label"><g:message code="usuario.fechaInicio.label" default="Fecha de registro" /></span>
					
						<span class="property-value" aria-labelledby="fechaInicio-label"><g:formatDate format="dd - MM - yyyy" date="${usuarioInstance?.fechaInicio}" /></span>
