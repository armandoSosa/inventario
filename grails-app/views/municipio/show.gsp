	...
	<body>
		...
		<div id="show-municipio" class="content scaffold-show" role="main">
			...
			<ol class="property-list municipio">
				...
				<g:if test="${municipioInstance?.direcciones}">
				<li class="fieldcontain">
					<span id="direcciones-label" class="property-label"><g:message code="municipio.direcciones.label" default="Direcciones" /></span>
