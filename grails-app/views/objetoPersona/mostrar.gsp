			...
			<ol class="property-list objetoPersona">
				...
				<li class="fieldcontain">
					<span id="objeto-label" class="property-label"><g:message code="objetoPersona.objeto.label" default="Objeto" /></span>
						...
						<span class="property-value" aria-labelledby="objeto-label"><g:link controller="objeto" action="mostrar" id="${objetoPersonaInstance?.objeto?.id}">${objetoPersonaInstance?.objeto?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="persona-label" class="property-label"><g:message code="objetoPersona.persona.label" default="Persona" /></span>
						...
						<span class="property-value" aria-labelledby="persona-label"><g:link controller="persona" action="mostrar" id="${objetoPersonaInstance?.persona?.id}">${objetoPersonaInstance?.persona?.encodeAsHTML()}</g:link></span>
