...
<html>
	...
	<body>
		<a href="#create-privilegioTipoUsuario" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-privilegioTipoUsuario" class="content scaffold-create" role="main">
			<h1><g:message code="default.create.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${privilegioTipoUsuarioInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${privilegioTipoUsuarioInstance}" var="error">
		...
		<div id="inline">		
			<div id="create-estado" class="content scaffold-create" role="main">
				...
				<g:form action="save_privilegio_tipoUsuario" controller="privilegio">
				<fieldset class="form">
					<g:render template="../privilegio/forma"/>
				</fieldset>
				<fieldset class="buttons">
					<g:submitButton name="create" class="save" value="${message(code: 'default.button.create.label', default: 'Create')}" />
				</fieldset>
		...
		<div id="inline2">		
			<div id="create-estado" class="content scaffold-create" role="main">
				...
				<g:form action="save_tipo_usuario_privilegio" controller="tipoUsuario">
				<fieldset class="form">
