...
<body>
	...
	<div id="create-caracteristica" class="content scaffold-create"
		role="main">
		<h1>
			<g:message code="Editar Característica" />
		...
		<g:form id="formcarac" name="formcarac" action="edit_caracteristica">
			<fieldset class="form">
				<div
				...
				<g:hiddenField name="idCaracteristica" id="idCaracteristica" value="${caracteristicaInstance?.id}"/>
			</fieldset>
