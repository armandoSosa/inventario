...
<body>
	...
	<div id="create-caracteristicaUnidad" class="content scaffold-create"
		role="main">
		<h1>
			<g:message code="Editar Característica Unidad" />
		</h1>
		...
		<g:form id="formcarac" name="formcarac" action="editar_caracUnidad">
			
			<fieldset id="field" name="field" class="form tooltip" title="">
				<g:hiddenField id="idCU" name="idCU" value="${caracteristicaUnidadInstance?.id}" />
