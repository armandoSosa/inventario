...
<html>
	...
	<body>
		<a href="#edit-objetoPersona" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-objetoPersona" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${objetoPersonaInstance?.version}" />
				<fieldset class="form">
