	...
	<body>
		...
		<div id="list-tipoPropiedad" class="content scaffold-list" role="main">
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="nombre" title="${message(code: 'tipoPropiedad.nombre.label', default: 'Nombre')}" />
				...
				<g:each in="${tipoPropiedadInstanceList}" status="i" var="tipoPropiedadInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${tipoPropiedadInstance.id}">${fieldValue(bean: tipoPropiedadInstance, field: "nombre")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${tipoPropiedadInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
