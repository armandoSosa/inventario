		...
		<fieldset class="form">	
			<div id="textFieldFormBuscar" class="fieldcontain ${hasErrors(bean: caracteristicaInstance, field: 'caracteristica', 'error')} ">
						...
						<g:if test="${personaInstance}">
							<g:textField name="persona" required="" value="${personaInstance.numeroEmpleado}" disabled="true"/> 
						</g:if>
						<g:else>
			...
			<div id="show-persona" class="content scaffold-show" role="main">
				...
				<ol class="property-list persona">
					...
					<li class="fieldcontain">
						...
						<img width= "300" height= "300" src="<g:createLink controller='persona' action='renderImage' id="${params.id}"/>"/>
					</li>
					</g:if>
